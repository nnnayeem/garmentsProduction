...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        $id=null;
        return view('admin.roles.create',compact('permissions','id'));
    }
    ...
    public function edit($id)
    {
        ...
        $perId = array();
        foreach ($rolePermission as $rpi){
            $perId[] = $rpi->id;//getting permission id
        }

        return view('admin.roles.edit', compact('role','permissions','id','perId'));
    }
