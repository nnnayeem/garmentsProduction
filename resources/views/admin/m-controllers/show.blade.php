...
@section('main')
    <section class="content-header">
        <h1>MController {{ $mcontroller->id }}</h1>
        <ol class="breadcrumb">
            <li><a href="/admin/"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{route("m-controllers.index")}}">m-controllers</a></li>
            <li class="active">Show m-controllers</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                       ...
                       <a href="{{ url('/admin/m-controllers') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                           <a href="{{ url('/admin/m-controllers/' . $mcontroller->id . '/edit') }}" title="Edit MController"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                           {!! Form::open([
                               'method'=>'DELETE',
                               'url' => ['admin/mcontrollers', $mcontroller->id],
                           ...
                           <div class="table-responsive">
                               <table class="table table-borderless">
                                   <tbody>
                                       <tr>
                                           <th>ID</th><td>{{ $mcontroller->id }}</td>
                                       </tr>
                                       <tr><th> Floor </th><td> {{ $mcontroller->floor }} </td></tr>
                                   </tbody>
                               </table>
                           </div>
