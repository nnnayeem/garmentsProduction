...
@section('main')
    <section class="content-header">
            <h1>Create New MController</h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
               <li><a href="{{route("m-controllers.index")}}">MController</a></li>
                <li class="active">Controller Register</li>
            </ol>
        </section>
                 ...
                 <div class="box-body">
                     <div class="row">
                         <div class="col-md-12">
                              ...
                              {!! Form::open(['url' => '/admin/m-controllers', 'class' => 'form-horizontal', 'files' => true]) !!}

                             @include ('admin.m-controllers.form')
