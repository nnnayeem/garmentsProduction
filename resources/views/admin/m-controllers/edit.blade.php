...
@section('main')
    <section class="content-header">
        <h1> Edit MController #{{ $mcontroller->id }}</h1>
        <ol class="breadcrumb">
            <li><a href="/admin/"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{route("m-controllers.index")}}">m-controllers</a></li>
            <li class="active">Edit m-controllers</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      {!! Form::model($mcontroller, [
                          'method' => 'PATCH',
                          'url' => ['/admin/m-controllers', $mcontroller->id],
                          'class' => 'form-horizontal',
                          'files' => true
                      ]) !!}

                      @include ('admin.m-controllers.form', ['submitButtonText' => 'Update'])
