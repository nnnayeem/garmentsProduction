            ...
            <div class="col-xs-12">
                <div class="box box-warning">
                    <div class="box-header">
                        <a href="/admin/permission/create" class="btn btn-flat btn-success">Add permissions</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th style="text-align: center">#</th><th style="text-align: center">Permission</th><th style="text-align: center">Actions</th>
                            </tr>
                            </thead>
