    ...
    <div class="row">
      ...
      <div class="col-md-3 col-lg-3 col-xs-6 col-sm-6">
        ...
        <div class="small-box bg-aqua">
          <div class="inner">
            <h3 class="count" id="newOrder">0</h3>
      ...
      <div class="col-md-3 col-lg-3 col-xs-6 col-sm-6">
        ...
        <div class="small-box bg-yellow">
          <div class="inner">
            <h3 class="count" id="newCustomer">0</h3>
      ...
      <div class="col-md-3 col-lg-3 col-xs-6 col-sm-6">
        ...
        <div class="small-box bg-red">
          <div class="inner">
            <h3 class="count" id="pendingDelivery">0</h3>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Goal Completion Report</h3>
          ...
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                ...
                <!-- /.progress-group -->
                <div id="newOrderGoal" class="progress-group">
                  <span class="progress-text">New Order</span>
                ...
                <!-- /.progress-group -->
                <div id="newCustomerGoal" class="progress-group">
                ...
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                      <span class="count" id="percentNewOrders">0</span>%
                    </span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">
                      <span class="count" id="percentNewMember">0</span>%
                    </span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
            ...
            <div class="row">
              <div class="col-sm-4 col-xs-6">
                <div class="description-block border-right">
                  ...
                  <h5 class="description-header">$<span class="" id="totalRevenue">0</span></h5>
              ...
              <div class="col-sm-4 col-xs-6">
                <div class="description-block border-right">
                  ...
                  <h5 class="description-header">$<span class="" id="totalCost">0</span> </h5>
              ...
              <div class="col-sm-4 col-xs-6">
                <div class="description-block border-right">
                  ...
                  <h5 class="description-header">$<span class="" id="totalProfit">0</span> </h5>
...
@section('script')
  ...
  <script src="{{asset('bower_resources/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
  <!-- jvectormap -->
  <script src="{{asset('bower_resources/admin-lte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
  <script src="{{asset('bower_resources/admin-lte/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
  <!-- Slimscroll -->
