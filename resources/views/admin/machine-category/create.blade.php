...
@section('main')
    <section class="content-header">
            <h1>Create New MachineCategory</h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
               <li><a href="{{route("machine-category.index")}}">MachineCategory</a></li>
                <li class="active">MachineCategory Create</li>
            </ol>
        </section>
                 ...
                 <div class="box-body">
                     <div class="row">
                         <div class="col-md-12">
                              ...
                              {!! Form::open(['url' => '/admin/machine-category', 'class' => 'form-horizontal', 'files' => true]) !!}

                             @include ('admin.machine-category.form')
