...
@section('main')
    <section class="content-header">
        <h1> Edit MachineCategory #{{ $machinecategory->id }}</h1>
        <ol class="breadcrumb">
            <li><a href="/admin/"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{route("machine-category.index")}}">machine-category</a></li>
            <li class="active">Edit machine-category</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      {!! Form::model($machinecategory, [
                          'method' => 'PATCH',
                          'url' => ['/admin/machine-category', $machinecategory->id],
                          'class' => 'form-horizontal',
                          'files' => true
                      ]) !!}

                      @include ('admin.machine-category.form', ['submitButtonText' => 'Update'])
