            ...
            <div class="col-xs-12">
                <div class="box box-warning">
                    <div class="box-header">
                        <a href="/admin/buyers/create" class="btn btn-flat btn-success">Add buyers</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            @foreach($buyers as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->name }}</td><td>{{ $item->email }}</td><td>{{ $item->country }}</td><td>{{ $item->address }}</td>
                                    <td>
                                        <a href="{{ url('/admin/buyers/' . $item->id) }}" title="View Buyer"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View Orders</button></a>
                                        <a href="{{ url('/admin/buyers/' . $item->id . '/edit') }}" title="Edit Buyer"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['/admin/buyers', $item->id],
