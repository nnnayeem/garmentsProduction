                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        @endif
                             ...
                             <a href="{{ url('/admin/accessorieses/' . $orderId) }}" title="View Accessoriese"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Back</button></a>
                             <a href="{{ url('/admin/accessorieses/' . $orderId.'/'. $accessoriese->id. '/edit') }}" title="Edit Accessoriese"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                             {!! Form::open([
                                 'method'=>'DELETE',
                                 'url' => ['/admin/accessorieses', $accessoriese->id],
                                 'style' => 'display:inline'
                             ]) !!}
                             {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i> Delete', array(
                                     'type' => 'submit',
                                     'class' => 'btn btn-danger btn-sm',
                                     'title' => 'Delete Accessoriese',
                           ...
                           <div class="table-responsive">
                               <table class="table table-borderless">
                                   <tbody>
                                       <tr>
                                           <th>ID</th><td>{{ $accessoriese->id }}</td>
                                       </tr>
                                       <tr><th> Name </th><td> {{ $accessoriese->name }} </td></tr><tr><th> Order Id </th><td> {{ $accessoriese->order_id }} </td></tr><tr><th> Qty </th><td> {{ $accessoriese->qty }} </td></tr>
                                   </tbody>
                               </table>
                           </div>
