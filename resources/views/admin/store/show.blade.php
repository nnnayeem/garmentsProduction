            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                       ...
                       <a href="{{ url('/admin/store') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                           <a href="{{ url('/admin/store/' . $store->id . '/edit') }}" title="Edit Store"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                           {!! Form::open([
                               'method'=>'DELETE',
                           ...
                           <div class="table-responsive">
                               <table class="table table-borderless">
                                   <tbody>
                                       ...
                                       <tr><th> Category </th><td> {{ $store->category }} </td></tr>
                                   </tbody>
                               </table>
                           </div>
