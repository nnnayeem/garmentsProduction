            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      {!! Form::model($machine, ['method' => 'PATCH','url' => ['/admin/machines', $machine->id],'class' => 'form-horizontal','files' => true]) !!}

                      @include ('admin.machines.form', ['submitButtonText' => 'Update'])
