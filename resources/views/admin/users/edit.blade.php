                      ...
                      {!! Form::model($user, [
                          ...
                          'files' => true
                             ...
                             <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                                 ...
                                 <div class="col-md-6">
                                     {!! Form::select('permission[]', $permissions, $assignedPermissions, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required','multiple','id'=>'permission'] : ['class' => 'form-control','multiple','id'=>'permission']) !!}
