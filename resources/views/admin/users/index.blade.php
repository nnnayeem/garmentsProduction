            ...
            <div class="col-xs-12">
                <div class="box box-warning">
                    <div class="box-header">
                        <a href="/admin/users/create" class="btn btn-flat btn-success">Add users</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th>#</th><th>Email</th><th>Name</th><th>Role</th><th>Created At</th><th>Actions</th>
                            </tr>
                            </thead>
                            ...
                            @foreach($users as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->email }}</td>
                                    <td>{{ $item->name }}</td>
                                    <td>{{ count($item->roles)>0?$item->roles->first()->name:'----' }}</td>
