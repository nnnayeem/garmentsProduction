<div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::select('permission[]', $permissions, null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required','multiple','id'=>'permission'] : ['class' => 'form-control','multiple','id'=>'permission']) !!}
...
<div class="form-group {{ $errors->has('password_confirmation') ? 'has-error' : ''}}">
    {!! Form::label('password_confirmation', 'Re Password', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::password('password_confirmation', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
