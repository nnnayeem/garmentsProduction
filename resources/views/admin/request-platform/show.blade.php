...
@section('main')
    <section class="content-header">
        <h1>RequestPlatform {{ $requestplatform->id }}</h1>
        <ol class="breadcrumb">
            <li><a href="/admin/"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{route("request-platform.index")}}">request-platform</a></li>
            <li class="active">Show request-platform</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                       ...
                       <a href="{{ url('/admin/request-platform') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                           <a href="{{ url('/admin/request-platform/' . $requestplatform->id . '/edit') }}" title="Edit RequestPlatform"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                           {!! Form::open([
                               'method'=>'DELETE',
                               'url' => ['admin/requestplatform', $requestplatform->id],
                               'style' => 'display:inline'
                           ]) !!}
                               {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i> Delete', array(
                                       'type' => 'submit',
                                       'class' => 'btn btn-danger btn-sm',
                                       'title' => 'Delete RequestPlatform',
                           ...
                           <div class="table-responsive">
                               <table class="table table-borderless">
                                   <tbody>
                                       <tr>
                                           <th>ID</th><td>{{ $requestplatform->id }}</td>
                                       </tr>
                                       <tr><th> Machine Category Id </th><td> {{ $requestplatform->machine_category_id }} </td></tr><tr><th> Machine Id </th><td> {{ $requestplatform->machine_id }} </td></tr><tr><th> Parts Id </th><td> {{ $requestplatform->parts_id }} </td></tr>
                                   </tbody>
                               </table>
                           </div>
