...
@section('main')
    <section class="content-header">
        <h1> Edit RequestPlatform #{{ $requestplatform->id }}</h1>
        <ol class="breadcrumb">
            <li><a href="/admin/"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{route("request-platform.index")}}">request-platform</a></li>
            <li class="active">Edit request-platform</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      {!! Form::model($requestplatform, [
                          'method' => 'PATCH',
                          'url' => ['/admin/request-platform', $requestplatform->id],
                          'class' => 'form-horizontal',
                          'files' => true
                      ]) !!}

                      @include ('admin.request-platform.form', ['submitButtonText' => 'Update'])
