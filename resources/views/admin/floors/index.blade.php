            ...
            <div class="col-xs-12">
                <div class="box box-warning">
                    <div class="box-header">
                        <a href="/admin/floors/create" class="btn btn-flat btn-warning">Add Floors</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th>#</th><th>Floor</th><th>Title</th><th>Actions</th>
                            </tr>
                            </thead>
                            <tbody valign = "middle">
                            @foreach($floors as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->floor }}</td><td>{{ $item->title }}</td>
                                    <td>
                                        <a href="{{ url('/admin/floors/' . $item->id) }}" title="View Floor"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                        <a href="{{ url('/admin/floors/' . $item->id . '/edit') }}" title="Edit Floor"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['/admin/floors', $item->id],
