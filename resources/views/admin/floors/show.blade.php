...
@section('main')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Show floors</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                       ...
                       <a href="{{ url('/admin/floors') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                           <a href="{{ url('/admin/floors/' . $floor->id . '/edit') }}" title="Edit Floor"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                           {!! Form::open([
                               'method'=>'DELETE',
                           ...
                           <div class="table-responsive">
                               <table class="table table-borderless">
                                   <tbody>
                                       <tr>
                                           <th>ID</th><td>{{ $floor->id }}</td>
                                       </tr>
                                       <tr><th> Floor </th><td> {{ $floor->floor }} </td></tr><tr><th> Title </th><td> {{ $floor->title }} </td></tr>
                                   </tbody>
                               </table>
                           </div>
