...
@section('main')
    <section class="content-header">
        <h1> Edit GeneralStore #{{ $generalstore->id }}</h1>
        <ol class="breadcrumb">
            <li><a href="/admin/"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{route("general-store.index")}}">general-store</a></li>
            <li class="active">Edit general-store</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      {!! Form::model($generalstore, [
                          'method' => 'PATCH',
                          'url' => ['/admin/general-store', $generalstore->id],
                          'class' => 'form-horizontal',
                          'files' => true
                      ]) !!}

                      @include ('admin.general-store.form', ['submitButtonText' => 'Update'])
