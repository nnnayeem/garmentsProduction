...
@section('main')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{route("accessorieses.index",['order'=>$generalstore->order_id])}}">Accessoriese</a></li>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        {!! Form::open(['url' => ['/admin/general-store',$generalstore->id], 'class' => 'form-horizontal', 'files' => true]) !!}
                        {!! Form::hidden('type',1) !!}
                        {!! Form::hidden('orderId',$generalstore->order_id) !!}
