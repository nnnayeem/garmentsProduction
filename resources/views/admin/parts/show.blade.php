            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                       ...
                       <a href="{{ url('/admin/parts') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                           <a href="{{ url('/admin/parts/' . $part->id . '/edit') }}" title="Edit Part"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                           {!! Form::open([
                               'method'=>'DELETE',
                           ...
                           <div class="table-responsive">
                               <table class="table table-borderless">
                                   <tbody>
                                       <tr>
                                           <th>ID</th><td>{{ $part->id }}</td>
                                       </tr>
                                       <tr><th> Parts </th><td> {{ $part->parts }} </td></tr><tr><th> Machine Category Id </th><td> {{ $part->machine_category_id }} </td></tr>
                                   </tbody>
                               </table>
                           </div>
