                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="chkbox-label-space">
                                                            {!!Form::checkbox('permissions[]', $permission->name,false,['class' => 'flat-red',$role->hasPermissionTo($permission->name)?'checked':''])!!}{{$permission->name}}
                                                        </label>
                                                    </td>
                                                </tr>
                                            @endforeach
                                ...
                                <div class = "form-group">
                                    {!!Form::submit('Update Role',['class' => 'btn btn-success btn-flat' ])!!}
                                </div>
